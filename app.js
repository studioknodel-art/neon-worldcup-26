...
let MATCHES=[], curStage="all", curQ="", openGroups=new Set(), pollTimer=null, lastPayload=null, lastLoadOk=false;
...
function renderSchedule(){
  ...
  items.forEach(m=>{
    ...
    const score=(live||m.state==="post")?`<span class="sc">${m.sa??0}–${m.sb??0}</span>`:"";
    r.innerHTML=`
